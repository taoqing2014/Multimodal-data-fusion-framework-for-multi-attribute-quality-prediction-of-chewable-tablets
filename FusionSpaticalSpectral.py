...
class HSI_SpectralSpatial_Feature_Extractor(nn.Module):

    def __init__(self, spectral_extractor, spatial_extractor, feature_dim=64):
        super(HSI_SpectralSpatial_Feature_Extractor, self).__init__()
        self.spectral_extractor = spectral_extractor  # 光谱特征提取器
        self.spatial_extractor = spatial_extractor  # 空间特征提取器
        self.fusion_module = AdaptiveFusion(feature_dim)  # 特征融合模块
